...
public class Controler {
    ...
    ArrayList<Controler> neighbourList;
    ...
    void addNeighbourControllerList(Controler v) {      //add infinite neghbour controllers
        neighbourList.add(v);
    }
    ...
    void controlStep() {
        ...
        for (Segment segment : list) {
            if (segment.hasTrain()) {
                ...
                Controler neighbourController = neighbourList.stream()
                        .filter(controler->controler.stationName.equals(t.getDestination()))
                        .findAny()
                        .orElse(null);
